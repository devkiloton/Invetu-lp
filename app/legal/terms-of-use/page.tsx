  ...
  return (
    <div className="flex flex-col gap-5 p-6 md:px-24">
      ...
      <p>
        <span>
          Ao acessar o app{" "}
          <a className="text-blue-600" href="https://app.invetu.com">
            Invetu
          </a>
      ...
      <p>
        <span>
          ...
          materiais (informações ou software) no site Invetu , apenas para
      ...
      <ol>
        ...
        <li>
          <span>
            transferir os materiais para outra pessoa ou &ldquo;espelhe&ldquo;
      ...
      <p>
        <span>
          ...
          dessas restrições e poderá ser rescindida por Invetu a qualquer
      ...
      <ol>
        <li>
          <span>
            Os materiais no site da Invetu são fornecidos &ldquo;como
            estão&ldquo;. Invetu não oferece garantias, expressas ou implícitas,
        ...
        <li>
          <span>
            Além disso, a Invetu não garante ou faz qualquer representação
      ...
      <p>
        <span>
          Em nenhum caso a Invetu ou seus fornecedores serão responsáveis ​​por
          ...
          incapacidade de usar os materiais em Invetu, mesmo que Invetu ou um
          representante autorizado da Invetu tenha sido notificado oralmente ou
      ...
      <p>
        <span>
          Os materiais exibidos no site da Invetu podem incluir erros técnicos,
          tipográficos ou fotográficos. Invetu não garante que qualquer material
          em seu site seja preciso, completo ou atual. Invetu pode fazer
          alterações nos materiais contidos em seu site a qualquer momento, sem
          aviso prévio. No entanto, Invetu não se compromete a atualizar os
          materiais.
        </span>
      </p>
      <h2 className="text-3xl font-bold">
      ...
      <p>
        <span>
          A Invetu não analisou todos os sites vinculados ao seu site e não é
          responsável pelo conteúdo de nenhum site vinculado. A inclusão de
          qualquer link não implica endosso por Invetu do site. O uso de
      ...
      <p>
        <span>
          A Invetu pode revisar estes termos de serviço do site a qualquer
      ...
      <p>
        <span>
          ...
          leis da Invetu e você se submete irrevogavelmente à jurisdição
